...
<html lang="es">
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.php">Hotel</a>
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item" href="dash-admi-hotel.php"><i class="app-menu__icon fa fa-chart-line"></i><span class="app-menu__label">Estadísticas</span></a></li>
        <li><a class="app-menu__item" href="reservaciones.php"><i class="app-menu__icon fa fa-hotel"></i><span class="app-menu__label">Reservaciones</span></a></li>
        <li><a class="app-menu__item" href="servicios.php"><i class="app-menu__icon fa fa-utensils"></i><span class="app-menu__label">Servicios</span></a></li>
